...
namespace ISO8583
{
    internal class Helper
    {
        ...
        internal static String PrepareVariableFieldData(DataElement de)
        {
            ...
            // Append the length to the left of the value
            // fieldData.Append(length.ToString().PadLeft(de.FieldLengthRepresentation.ToString().Length, '0'));
            //fieldData.Append();

            // Print to the console
            // Console.WriteLine($"Length: {length}, Value: {de.Value}");
